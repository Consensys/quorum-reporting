...
var (
	testIndexBlock = &types.Block{
		...
		Transactions: []types.Hash{
			...
			types.NewHash("0x86835cbb6c0502b5e67a30b20c4ad79a169d13782f74557775557f52307f0bdb"),
		},
	}
...
func TestContractCreationFilter_ProcessBlocks_UnableToReadTransaction(t *testing.T) {
	...
	err := ccFilter.ProcessBlocks([]types.Address{sampleAddress}, []*types.Block{testIndexBlock})
...
func TestContractCreationFilter_ProcessBlocks(t *testing.T) {
	...
	_ = db.WriteTransactions(transactionList)
	...
	err := ccFilter.ProcessBlocks(testAddresses, []*types.Block{testIndexBlock})
	assert.Nil(t, err)
...
func TestContractCreationFilter_ProcessBlocks_NonIndexedContracts(t *testing.T) {
	...
	err := ccFilter.ProcessBlocks([]types.Address{}, []*types.Block{testIndexBlock})
	assert.Nil(t, err)
